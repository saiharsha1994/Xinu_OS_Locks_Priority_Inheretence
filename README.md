...
Electronic turn-in instructions
        ...
        i) go to the csc501-lab2-qemu/compile directory and do "make clean".

        ii) go to the directory of which your csc501-lab2-qemu directory is a subdirectory (NOTE: please do not rename csc501-lab2-qemu, or any of its subdirectories.)

                e.g., if /home/csc501/csc501-lab2-qemu is your directory structure, goto /homes/csc501

        iii) create a subdirectory TMP (under the directory csc501-lab2-qemu) and copy all the files you have modified/written, both .c files and .h files into the directory.

        iv) compress the csc501-lab2-qemu directory into a tgz file and use Wolfware's Submit Assignment facility. Please only upload one tgz file.
...
Note
POST your questions on the message board. Please do not send email if not necessary
Welcome to share your test cases on the message board, but not any programming details
Test cases available only for reference but not for correctness:
test_main.c